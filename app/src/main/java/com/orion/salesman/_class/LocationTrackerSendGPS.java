...
public class LocationTrackerSendGPS implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    private static final String TAG = LocationTrackerSendGPS.class.getSimpleName();

    private static LocationTrackerSendGPS mInstance;
    ...
    public static LocationTrackerSendGPS getInstance() {
        if (null == mInstance) {
            mInstance = new LocationTrackerSendGPS();
        }
        return mInstance;
    }
