 ...
 */
public class MsgOutbox extends Fragment implements View.OnClickListener {
    private String DATE;
    private MsgAdapter mAdapter;
    private List<ObjA0004> arrayList = new ArrayList<>();
    private RecyclerView recyclerView;
    String TAG = "MsgOutbox";
    public static MsgOutbox instance = null;
...
//        handler.removeCallbacks(ThreadSend);
    ...
    public void onResume() {
        ...
        boolean flag = prefManager.getOutBox();
        if (flag) {
            new PrefManager(getActivity()).setOutBox(false);
            A00044();
