 ...
 */
public class ResultGumFragment extends Fragment {
    ...
    public static ResultGumFragment instance;
    ...
    public void initView(View v) {
        ...
        ResultGumFragment fm = this;
        mAdapter = new ResultPieAdapter(getActivity(), arrayList, null, null, fm);
            ...
            else
            {
                ...
                if (listAPI_304 != null && listAPI_304.getRESULT() == 0) {
                    ...
                    for (int i = 0; i < LIST.size(); i++) {
                        ...
                        if (ob.getV1().equals(Const.GTEAM) && ob.getV4().equals("T") && !ob.getV2().equals("T")) {
                            arrayList.add(ob);
                        }
                    }
                    for (int i = 0; i < arrayList.size(); i++) {
                        ...
                        for (int k = 0; k < LIST.size(); k++) {
                            ...
                            if (ob.getV1().equals(Const.GTEAM)
                                    && !ob.getV4().equals("T")
                                    && !ob.getV2().equals("T")
